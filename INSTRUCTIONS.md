...
To practice passing values through `props` in React, you will build the gallery using 

[] Make mulitple components - an `App`, `GalleryList`, and `GalleryItem`.
    [] Connect them to App.js
